...
patch = run("PATCH", [sys.executable, "scripts/apply_continuation_ui_pass.py"])
...
if subprocess.run(["git", "diff", "--cached", "--quiet"], cwd=ROOT).returncode != 0:
    message = "Apply validated visible beta UI" if build == 0 else "Record visible beta UI validation"
