...
| GENUI-04 | Shell/header/navigation, Apps panel and direct Haven launch | GENUI-01, GENUI-02 | In progress | Direct New Haven startup, Go, unique Apps coverage and header controls exist; user runtime screenshots exposed selected-tab, Add popup and multiple destination-layout defects now under repair. Complete route/device/cold-start matrix remains |
