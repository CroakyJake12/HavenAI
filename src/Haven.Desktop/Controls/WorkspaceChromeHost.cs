/*
 * FILE DOCUMENTATION
 * Where: src/Haven.OldHaven/Controls/WorkspaceChromeHost.cs, in the Desktop controls layer, containing reusable Avalonia behavior and visual building blocks.
