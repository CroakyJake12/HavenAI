...
public sealed class HavenIcon : PathIcon
{
    ...
    private static IReadOnlyDictionary<string, Geometry> BuildIcons()
    {
        ...
        Add("teach", "M12,3 L2,8.5 L6,10.7 L6,16 L12,20 L18,16 L18,10.7 L20,9.6 L20,15 L22,15 L22,8.5 Z M8,11.8 L12,14 L16,11.8 L16,15 L12,17.5 L8,15 Z", "lesson", "education");
        ...
        Add("studio", "M12,2 C6.5,2 2,6 2,11 C2,15.2 5.4,18 9,18 L10,18 C10.6,18 11,18.4 11,19 C11,20.7 12.3,22 14,22 C18.4,22 22,17.5 22,12 C22,6.5 17.5,2 12,2 Z M7,8 C5.9,8 5,7.1 5,6 C5,4.9 5.9,4 7,4 C8.1,4 9,4.9 9,6 C9,7.1 8.1,8 7,8 Z M12,6 C10.9,6 10,5.1 10,4 C10,2.9 10.9,2 12,2 C13.1,2 14,2.9 14,4 C14,5.1 13.1,6 12,6 Z M17,8 C15.9,8 15,7.1 15,6 C15,4.9 15.9,4 17,4 C18.1,4 19,4.9 19,6 C19,7.1 18.1,8 17,8 Z", "palette");
        ...
        Add("chevron-left", "M15.5,4 L7.5,12 L15.5,20 L18,17.5 L12.5,12 L18,6.5 Z");
        ...
        Add("refresh", "M12,3 C16.4,3 20.1,6.1 21,10.3 L18,10.3 C17.2,7.8 14.9,6 12,6 C8.7,6 6,8.7 6,12 C6,15.3 8.7,18 12,18 C14.5,18 16.7,16.5 17.6,14.3 L20.8,14.3 C19.8,18.2 16.2,21 12,21 C7,21 3,17 3,12 C3,7 7,3 12,3 Z M18,3 L22,3 L22,7 Z");
        ...
        Add("hang-up", "M4,9 C9.3,5.8 14.7,5.8 20,9 C21.2,9.7 21.5,11.2 20.8,12.4 L18.6,16.2 C18,17.2 16.8,17.6 15.7,17.1 L12.8,15.7 C12.3,15.4 12,14.9 12,14.3 L12,12.2 C10.7,12 9.3,12 8,12.2 L8,14.3 C8,14.9 7.7,15.4 7.2,15.7 L4.3,17.1 C3.2,17.6 2,17.2 1.4,16.2 L0.2,12.4 C-0.5,11.2 -0.2,9.7 1,9 Z");
        ...
        Add("rapid", "M13,2 L4,14 L11,14 L10,22 L20,10 L13,10 Z");
