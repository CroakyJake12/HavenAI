...
public sealed class HavenIcon : PathIcon
{
    ...
    private static IReadOnlyDictionary<string, Geometry> BuildIcons()
    {
        ...
        Add("map", "M20.5,3 L20.34,3.03 L15,5.1 L9,3 L3.36,4.9 C3.15,5.6 3,6.1 3,6.1 L3,21 C3,21.55 3.45,22 4,22 L4.16,21.97 L9,19.9 L15,22 L20.64,20.1 C20.85,19.4 21,18.9 21,18.9 L21,4 C21,3.45 20.55,3 20.5,3 Z M15,19 L9,16.89 L9,5 L15,7.11 L15,19 Z");
        ...
        Add("arrow-up", "M12,2 L22,12 L16,12 L16,22 L8,22 L8,12 L2,12 Z", "up-arrow");
        Add("user", "M12,2 C15.3,2 18,4.7 18,8 C18,11.3 15.3,14 12,14 C8.7,14 6,11.3 6,8 C6,4.7 8.7,2 12,2 Z M3,22 C3.5,17.6 7.1,15 12,15 C16.9,15 20.5,17.6 21,22 Z", "person", "account");
