/*
 * FILE DOCUMENTATION
 * Where: src/Haven.Desktop/Controls/WorkspaceChromeHost.ActionsBridge.cs, in the Desktop controls layer, containing reusable Avalonia behavior and visual building blocks.
