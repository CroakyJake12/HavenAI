/*
 * FILE DOCUMENTATION
 * Where: src/Haven.Desktop/Views/ConversationRetrievalView.axaml.cs, in the Desktop view layer, where Avalonia controls connect XAML interaction to view models.
 * What: This file owns ConversationRetrievalView. Read the type and member comments below as a map of each responsibility.
...
/// <summary>
/// Represents conversation retrieval view and keeps its related state and behavior together.
/// </summary>
public sealed partial class ConversationRetrievalView : UserControl
{
    ...
    /// <summary>
    /// Handles the use composer query clicked event raised by the UI or runtime.
    /// </summary>
