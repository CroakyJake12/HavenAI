...
internal sealed class CanvasHueStrip : HavenElement, IHavenDrawCommandSource, IHavenPointerInputTarget
{
    ...
    public CanvasHueStrip()
    {
        ...
        SetValue(HavenProperties.Width, HavenLength.Px(240));
    ...
    public void Draw(HavenDrawingContext context, double opacity)
    {
        ...
        for (var i = 0; i < segments; i++)
        {
            ...
            var rect = new HavenRect(Bounds.X + i * step, Bounds.Y, step + 1, Bounds.Height);
            context.Add(new HavenFillRoundedRectCommand(rect, new HavenSolidBrush(255, r, g, b), 0, opacity));
        }
        ...
        context.Add(new HavenStrokeRoundedRectCommand(
            ...
            new HavenPen(new HavenSolidBrush(255, 255, 255, 255), 2),
            3,
            opacity));
    }
