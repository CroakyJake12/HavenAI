/*
 * FILE DOCUMENTATION
 * Where: src/Haven.OldHaven/Services/NotesDictationController.cs, in the Desktop services layer, adapting application behavior to Windows and Avalonia concerns.
