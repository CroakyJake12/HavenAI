/*
 * FILE DOCUMENTATION
 * Where: src/Haven.OldHaven/Services/CallVoicePreviewController.cs, in the Desktop services layer, adapting application behavior to Windows and Avalonia concerns.
