...
public static class CapabilityRegistryCatalog
{
    ...
    [
        ...
        BuiltIn("browser-use", "Browser Use", "Navigate and interact through Haven's isolated browser.", "browse", "browser-use", "browser.interactive", "[\"navigate\",\"inspect\",\"interact\"]", CapabilityPlatform.All, CapabilityRiskClass.Consequential, CapabilityAvailability.PermissionRequired, provider: "haven.browser"),
        BuiltIn("create-automation", "Create Automation", "Create a reviewable scheduled action in Automations.", "automations", "automation", "tasks.automation.create", "[\"create\",\"schedule\"]", CapabilityPlatform.All, CapabilityRiskClass.Consequential, CapabilityAvailability.PermissionRequired, provider: "haven.tasks"),
