/*
 * FILE DOCUMENTATION
 * Where: src/Haven.Core/DomainLogic/PluginCatalog.cs, in the dependency-free Core layer, where shared domain models and rules live.
...
public static class PluginCatalog
{
    ...
    /// <summary>
    /// Creates a built-in plugin definition.
    /// </summary>
...
public static class PromptCatalog
{
    ...
    /// <summary>
    /// Creates a built-in prompt definition.
    /// </summary>
...
{
    /// <summary>
    /// Creates a deterministic GUID from a stable name.
    /// </summary>
