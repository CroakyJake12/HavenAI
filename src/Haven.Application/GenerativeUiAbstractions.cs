...
public static class GenerativeUiCatalog
{
    ...
    [
        ...
        new("study", "Study", "Open the Study surface.", "study"),
        new("call", "Call", "Open the live Call surface.", "call"),
        new("tasks", "Tasks", "Open the task and automation surface.", "tasks"),
        new("studio", "Studio", "Open Haven Studio.", "code"),
        new("browse", "Browse", "Open Haven Browse.", "globe"),
        new("plan", "Plan", "Open Haven Plan.", "calendar"),
        new("imagine", "Imagine", "Create and refine visual ideas.", "imagine"),
        new("present", "Present", "Plan and produce presentations.", "present"),
        new("data", "Data", "Explore and analyse structured data.", "data"),
        new("vision", "Vision", "Inspect and reason about visual material.", "vision"),
        new("play", "Play", "Open the games and interactive workspace.", "play"),
        new("translate", "Translate", "Translate and localise content.", "translate"),
        new("launcher", "Launcher", "Find and launch Haven capabilities.", "launcher"),
        new("go", "Go", "Open proactive suggestions and next actions.", "go"),
        new("dashboard", "Dashboard", "Open your configurable dashboard.", "dashboard"),
