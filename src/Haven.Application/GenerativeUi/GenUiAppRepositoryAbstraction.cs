...
public interface IGenUiAppRepository
{
 ...
 Task<IReadOnlyList<GenUiAppDefinition>> GetPinnedAsync(int limit,CancellationToken cancellationToken);
 Task SetPinnedAsync(Guid instanceId,bool pinned,CancellationToken cancellationToken);
